<template>
  ...
  export default {
    data() {
      return {
        cards: [
          { id: 1, name: 'Liang', gender: '男', Phonenumber: '110', IDnumber: '123', job: '工人', address: '1', photo: './1.jpg' },
          { id: 2, name: 'Zou', gender: '男', Phonenumber: '120', IDnumber: '456', job: '工人', address: '2', photo: './2.jpg' },
          { id: 3, name: 'Chen', gender: '男', Phonenumber: '119', IDnumber: '789', job: '工人', address: '3', photo: './3.jpg' },
          { id: 4, name: 'Ma', gender: '女', Phonenumber: '999', IDnumber: '789', job: '经理', address: '4', photo: './4.jpg' },
        ],
        filter: '',
        editedCard: {},
        dialog: false,
